...
project = 'django-prbac'
copyright = '2013, Dimagi'
...
latex_documents = [
  ('index', 'django-prbac.tex', 'django-prbac Documentation',
   'Dimagi', 'manual'),
]
...
man_pages = [
    ('index', 'django-prbac', 'django-prbac Documentation',
     ['Dimagi'], 1)
]
...
texinfo_documents = [
  ('index', 'django-prbac', 'django-prbac Documentation',
   'Dimagi', 'django-prbac', 'One line description of project.',
   'Miscellaneous'),
]
